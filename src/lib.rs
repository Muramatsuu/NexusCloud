...
#[derive(Debug)]
pub struct NexusCloudProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NexusCloudProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NexusCloud processing");
    
    let mut processor = NexusCloudProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NexusCloudProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NexusCloudProcessor::new(false);
